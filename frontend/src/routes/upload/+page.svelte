<script lang="ts">
	...
	import { api, type Game, type RulesInfoResponse, type UploadResponse } from '$lib';
...
<div class="bg-background min-h-screen">
		...
		<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
			<div class="flex items-center justify-between py-6">
				...
				<nav class="flex space-x-8">
					...
					<a href="/upload" class="text-foreground font-medium transition-colors">Upload Rules</a>
	...
	<main class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
									...
									>
										<div class="flex items-start justify-between">
											<div class="flex-1 min-w-0">
												<h3 class="font-medium text-gray-900 truncate">{game.name}</h3>
												{#if game.publisher}
				...
				{#if selectedGame}
					...
					<Card class="mt-6">
						...
						<CardContent class="space-y-3">
							...
							{/if}
							<div class="pt-3">
								<Button variant="outline" onclick={() => goToGame(selectedGame.id)} class="w-full">
									View Game Details
								</Button>
							</div>
						</CardContent>
						...
						<Card class="mt-6">
							...
							<CardContent class="space-y-4">
								...
								<div class="flex space-x-3">
									<Button onclick={() => goToGame(selectedGame.id)}>View Game Details</Button>
		...
		<!-- Additional Features -->
		<div class="mt-12">
			<h2 class="text-xl font-semibold text-gray-900 mb-4">What happens after upload?</h2>
