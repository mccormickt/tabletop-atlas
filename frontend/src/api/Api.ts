...
{"assistantMessage": ChatMessage,"contextSources": (ContextSource)[],"userMessage": ChatMessage,};
...
{"categoryScores": Record<string,number>,"name": string,"total": number,};
...
{"enabledExpansions": (string)[],"players": (PlayerScoreInput)[],};

export type ScoreOutput =
{"players": (PlayerScoreResult)[],"winnerIndex"?: number | null,};

export type ThresholdEntry =
{"max": number,"min": number,"score": number,};
...
{"displayName": string,"id": string,"inputType": InputType,"max"?: number | null,"min"?: number | null,
/** If set, this category only appears when this expansion is enabled */
"requiresExpansion"?: string | null,"rule": ScoringRule,"step"?: number | null,};

export type ScoringSchema =
{"categories": (ScoringCategory)[],"expansions": (Expansion)[],};
...
{"displayName": string,"id": string,"playerRange": PlayerRange,"schema": ScoringSchema,"toolType": ToolType,};

export type ToolSummary =
{"displayName": string,"id": string,"playerRange": PlayerRange,"toolType": ToolType,};
 ...
 */
calculateScores: ({ 
path, body, }: {path: CalculateScoresPathParams,
body: ScoreInput,
},
params: FetchParams = {}) => {
